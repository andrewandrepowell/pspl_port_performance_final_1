# Runtime Tcl commands to interact with - hardware_accelerator_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/hardware_accelerator_v1_0_include.tcl
...
# Test: s_axi_lite_registers
# Create a write transaction at s_axi_lite_registers_addr address
create_hw_axi_txn w_s_axi_lite_registers_addr [get_hw_axis $jtag_axi_master] -type write -address $s_axi_lite_registers_addr -data $wdata_1
# Create a read transaction at s_axi_lite_registers_addr address
create_hw_axi_txn r_s_axi_lite_registers_addr [get_hw_axis $jtag_axi_master] -type read -address $s_axi_lite_registers_addr
# Initiate transactions
run_hw_axi r_s_axi_lite_registers_addr
run_hw_axi w_s_axi_lite_registers_addr
run_hw_axi r_s_axi_lite_registers_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s_axi_lite_registers_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - s_axi_lite_registers"
} else {
	puts "Data comparison test fail for - s_axi_lite_registers, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
...
# Test: m_axi_full_data
set wdata_m_axi_full_data [get_init_data 0]
create_hw_axi_txn w_m_axi_full_data_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_axi_full_data}
create_hw_axi_txn r_m_axi_full_data_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_axi_full_data_addr
run_hw_axi w_m_axi_full_data_addr
run_hw_axi r_m_axi_full_data_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_axi_full_data_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - m_axi_full_data"
} else {
	puts "Data comparison test fail for - m_axi_full_data, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
