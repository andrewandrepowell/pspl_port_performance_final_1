...
proc create_hier_cell_hier_hardware_accelerator_0_4 { parentCell nameHier } {
  ...
  set_property -dict [ list \
CONFIG.C_axi3_monitor_DATA_WIDTH {64} \
CONFIG.C_axi3_monitor_ID_WIDTH {6} \
 ] $axi3_metrics_counter_0
...
CONFIG.NUM_MI {1} \
  ...
  set_property -dict [ list \
CONFIG.C_buffer_size {4} \
CONFIG.C_m_axi_full_data_DATA_WIDTH {64} \
CONFIG.C_m_axi_full_data_ID_WIDTH {6} \
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_1] [get_bd_intf_pins axi3_metrics_counter_0/axi3_monitor] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
...
proc create_hier_cell_hier_hardware_accelerator_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
CONFIG.C_axi3_monitor_DATA_WIDTH {64} \
CONFIG.C_axi3_monitor_ID_WIDTH {2} \
 ] $axi3_metrics_counter_0
...
CONFIG.C_buffer_size {4} \
CONFIG.C_m_axi_full_data_DATA_WIDTH {64} \
CONFIG.C_m_axi_full_data_ID {2} \
CONFIG.C_m_axi_full_data_ID_WIDTH {2} \
 ] $hardware_accelerator_0
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -y 630 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 650 -defaultsOSRD
preplace inst hier_ps -pg 1 -lvl 3 -y 730 -defaultsOSRD
preplace inst hier_readies -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst hier_pspl_port_hp0 -pg 1 -lvl 2 -y 990 -defaultsOSRD
preplace inst hier_pspl_port_hp1 -pg 1 -lvl 2 -y 1370 -defaultsOSRD
preplace inst hier_pspl_port_hp2 -pg 1 -lvl 2 -y 1180 -defaultsOSRD
preplace inst hier_pspl_port_acp -pg 1 -lvl 2 -y 690 -defaultsOSRD
preplace inst hier_enables -pg 1 -lvl 1 -y 720 -defaultsOSRD
preplace inst hier_pspl_port_gp0 -pg 1 -lvl 2 -y 360 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 3 1 N
preplace netloc hier_ps_m_axi_acp 1 1 3 390 550 NJ 550 1140
preplace netloc hier_pspl_port_hp1_m_axi 1 2 1 810
preplace netloc hier_pspl_port_hp0_m_axi 1 2 1 770
preplace netloc hier_ps_aclk 1 1 3 330 830 NJ 920 1170
preplace netloc processing_system7_0_GPIO_O 1 0 4 10 570 NJ 570 NJ 570 1170
preplace netloc hier_ps_interconnect_aresetn 1 1 3 350 840 NJ 910 1130
preplace netloc hier_readies_interrupts 1 2 1 830
preplace netloc hier_pspl_port_gp0_ready 1 1 2 390 10 700
preplace netloc hier_pspl_port_acp_ready 1 1 2 360 460 710
preplace netloc hier_enables_local_enable_hp0 1 1 1 320
preplace netloc hier_enables_local_enable_hp1 1 1 1 290
preplace netloc hier_pspl_port_hp2_m_axi 1 2 1 820
preplace netloc hier_enables_local_enables 1 1 1 310
preplace netloc hier_enables_local_enable_acp 1 1 1 N
preplace netloc processing_system7_0_FIXED_IO 1 3 1 N
preplace netloc hier_ps_m_axi_hp0 1 1 3 370 860 NJ 900 1180
preplace netloc hier_pspl_port_gp0_m_axi 1 2 1 820
preplace netloc local_enable_1 1 1 1 280
preplace netloc hier_ps_m_axi_hp1 1 1 3 380 870 NJ 880 1150
preplace netloc hier_ps_peripheral_aresetn 1 1 3 340 850 NJ 930 1160
preplace netloc hier_enables_global_enable 1 1 1 300
preplace netloc hier_ps_m_axi_hp2 1 1 3 390 880 NJ 890 1140
preplace netloc hier_ps_m_axi_gp0 1 1 3 390 250 NJ 250 1180
preplace netloc hier_enables_local_enable_gp0 1 1 1 280
preplace netloc hier_pspl_port_acp_m_axi 1 2 1 N
preplace netloc hier_pspl_port_hp2_ready 1 1 2 380 580 700
preplace netloc hier_pspl_port_hp1_ready 1 1 2 370 470 720
preplace netloc hier_pspl_port_hp0_ready 1 1 2 390 240 730
levelinfo -pg 1 -10 150 560 980 1200 -top 0 -bot 1470
",
}
