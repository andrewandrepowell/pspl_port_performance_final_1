#-----------------------
#Creating new core.
ipx::create_core {xilinx.com} {ip} {bram64} {1.0}
#-----------------------
...
set_property description {bram64} [ipx::current_core]
set_property display_name {bram64} [ipx::current_core]
...
ipx::add_file bram64_ooc.xdc [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_file hw_handoff/bram64.hwh [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_file hw_handoff/bram64_bd.tcl [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_file ip/bram64_axi_bram_ctrl_0_1/bram64_axi_bram_ctrl_0_1.xci [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_file ip/bram64_blk_mem_gen_0_1/bram64_blk_mem_gen_0_1.xci [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
ipx::add_file hdl/bram64.v [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]
set_property {model_name} {bram64} [ipx::get_file_groups xilinx_verilogsynthesis -of_objects [ipx::current_core]]

#-----------------------
# SIMULATION FILESET
#-----------------------
ipx::add_file_group {xilinx_verilogbehavioralsimulation} [ipx::current_core]
ipx::add_file bram64_ooc.xdc [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
ipx::add_file hw_handoff/bram64.hwh [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
ipx::add_file hw_handoff/bram64_bd.tcl [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
ipx::add_file ip/bram64_axi_bram_ctrl_0_1/bram64_axi_bram_ctrl_0_1.xci [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
ipx::add_file ip/bram64_blk_mem_gen_0_1/bram64_blk_mem_gen_0_1.xci [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
ipx::add_file hdl/bram64.v [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]
set_property {model_name} {bram64} [ipx::get_file_groups xilinx_verilogbehavioralsimulation -of_objects [ipx::current_core]]

#-----------------------
# PORTS 
#-----------------------
ipx::add_ports_from_hdl [::ipx::current_core] -top_level_hdl_file ./hdl/bram64.v -top_module_name bram64
