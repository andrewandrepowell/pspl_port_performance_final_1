...
//Date        : Fri Jun 12 12:52:51 2015
//Host        : idea-PC running 64-bit major release  (build 9200)
//Command     : generate_target bram32.bd
//Design      : bram32
...
module bram32
  ...
  assign S_AXI_1_WDATA = s_axi_full_wdata[31:0];
  assign S_AXI_1_WLAST = s_axi_full_wlast;
  assign S_AXI_1_WSTRB = s_axi_full_wstrb[3:0];
  ...
  assign s_axi_full_rdata[31:0] = S_AXI_1_RDATA;
